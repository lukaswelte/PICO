...
alter table entry drop constraint fk_entry_user_1;
alter table label drop constraint fk_label_user_2;


alter table entry_label drop constraint fk_entry_label_entry_01;
alter table entry_label drop constraint fk_entry_label_label_02;
